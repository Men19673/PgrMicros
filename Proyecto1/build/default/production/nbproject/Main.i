...
;---------------------------VECTOR INTERRUPT------------------------------------
 ...
 RETFIE ;Regreso de la Interrupcion y volvemos a activar ((INTCON) and 07Fh), 7

;------------------------- SUBRUTINAS INTERRUPT -------------------------------
   pushbt:
    btfss PORTB, 0 ;Verificar si el ((PORTB) and 07Fh), 0 esta presionado
    BSF flagint, 0
    btfss PORTB, 1 ;Verfiicar si el ((PORTB) and 07Fh), 1 esta presionado
    BSF flagint, 1
    btfss PORTB, 2 ;Verfiicar si el ((PORTB) and 07Fh), 1 esta presionado
    BSF flagint, 2
    bcf INTCON,0 ;Limpiar bandera ((INTCON) and 07Fh), 0
    RETURN
