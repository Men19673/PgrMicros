...
SOURCEFILES_QUOTED_IF_SPACED=Lab2Pgr.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Lab2Pgr.o
POSSIBLE_DEPFILES=${OBJECTDIR}/Lab2Pgr.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/Lab2Pgr.o

# Source Files
SOURCEFILES=Lab2Pgr.s
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/Lab2Pgr.o: Lab2Pgr.s  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Lab2Pgr.o 
	${MP_AS} -mcpu=PIC16F887 -c \
	-o ${OBJECTDIR}/Lab2Pgr.o \
	Lab2Pgr.s \
...
dist/${CND_CONF}/${IMAGE_TYPE}/Lab2.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	-o dist/${CND_CONF}/${IMAGE_TYPE}/Lab2.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
